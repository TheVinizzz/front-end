...
import Youpop from '../../assets/logo youpop.png'
                        ...
                        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                            <div className="relative flex h-16 items-center justify-between">
                                            ...
                                            {navigation.map((item: any) => (
                                                <a
                                                    ...
                                                    className={classNames(
                                                        item.current ? 'bg-purple-900 text-white' : 'text-gray-900 hover:bg-violet-500 hover:text-white',
                                ...
                                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                                    {/* <button
                                        type="button"
                                        className="rounded-full bg-violet-700 p-1 text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                                    >
                                        ...
                                        <div>
                                            <Menu.Button className="flex rounded-full bg-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                                ...
                                                <img
                                                    ...
                                                    src="https://cdn-icons-png.flaticon.com/512/18/18148.png"
                                                    alt=""
                                                />
                                            </Menu.Button>
                                        </div>
                            ...
                            <div className="space-y-1 px-2 pb-3 pt-2">
                                {navigation.map((item) => (
                                    <Disclosure.Button
                                        ...
                                        href={item.href}
                                        className={classNames(
                                            item.current ? 'bg-purple-800 text-white' : 'text-gray-900 hover:bg-violet-500 hover:text-white',
